...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/sequence.css" type="text/css" />
...
<body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body-" . $pageClass;?>">
    <div class="wrapper">
                        ...
                        <div id="component_wrapper">
                            ...
                            <div id="content-row-1" class="row">
                                <div class="content-row-1">
                                    <jdoc:include type="modules" name="as-position-20" style="html5nosize" />
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div id="content-row-2" class="row">
                                <div class="content-row-2">
                                    <jdoc:include type="modules" name="as-position-21" style="html5nosize" />
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div id="content-row-3" class="row">
                                <div class="content-row-3">
                                    <jdoc:include type="modules" name="as-position-22" style="html5nosize" />
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>    
        ...
        <!-- FOOTER ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
        <div id="footer" <?php if (!$this->countModules('as-position-25')) echo 'style="margin-top: 40px;"'; ?>>
