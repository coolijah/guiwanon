...
<body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body-" . $pageClass;?>">
	<div class="main-wrapper">
    	...
    	<div id="header">
            ...
            <div id="header-row" <?php if(!$this->countModules('as-position-5')) echo 'class="solid2"'; ?> >
                <div class="container">
        ...
        <div id="content-wrapper">     
           <div class="main">
               ...
               <?php endif; ?>
                ...
                <div id="content-row-4" <?php if ($this->countModules('as-position-24')) echo 'class="expander"'; ?>>
